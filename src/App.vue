<template>
  <main class=" lg:w-[40vw] lg:mx-auto lg:my-[25vh] lg:h-[50vh] lg:flex ">
    ...
    <section class=" ">
      ...
      <div class=" flex justify-center items-center  bg-darkCyan mt-7 w-full h-14 rounded-lg text-white">
        <img class=" h-1/3" src="product-preview-card-component-main/images/icon-cart.svg" alt="">
